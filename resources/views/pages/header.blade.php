...
<div class="container-fluid">
    <div class="row p-60-0 p-lg-30-0 p-md-15-0">
        <div class="col-lg-12">
            <div class="art-a art-banner" style="background-image: url({{asset('assets/img/bg.jpg')}})">
                ...
                <div class="art-banner-overlay">
                    <div class="art-banner-title">
                        ...
                        <div class="art-lg-text art-code mb-25">&lt;<i>code</i>&gt; I build <span class="txt-rotate" data-period="2000"
                            data-rotate='[ "web applications.", "system applications.", "design mocups.", "automation tools." ]'></span>&lt;/<i>code</i>&gt;</div>
                        <div class="art-buttons-frame">
                        <a href="#." class="art-btn art-btn-md"><span>Hire me</span></a>
                        {{-- <a href="#." class="art-link art-white-link art-w-chevron">Hire me</a> --}}
                        </div>
                    </div>
                    <img src="{{asset('assets/img/mc/toppic1.png')}}" class="art-banner-photo" alt="Your Name">
                </div>
            </div>
        </div>
    </div>
