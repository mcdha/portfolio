        ...
        <form id="getintouch_form" class="art-contact-form" enctype="multipart/form-data">
            ...
            <div class="art-form-field">
                <input id="name" name="name" class="art-input" type="text" placeholder="Name" required
                    minlength="2" maxlength="255" pattern="[A-Za-z\s]+" title="Only letters and spaces are allowed.">
                <label for="name"><i class="fas fa-user"></i></label>
            </div>
            <div class="art-form-field">
                <input id="occupation" name="occupation" class="art-input" type="text" placeholder="Occupation"
            ...
            <div class="art-form-field">
                <textarea id="message" name="message" class="art-input" placeholder="Message" required minlength="10" maxlength="1000"
                    pattern="^[^<>=;{}]*$" title="Special characters like <, >, =, ;, and {} are not allowed."></textarea>
                <label for="message"><i class="far fa-envelope"></i></label>
            </div>
            <div class="d-flex">
                <h4 style="margin-right: 2rem">Is this a Question or Testimonial?</h4>
                <span style="margin-right: 10px">
                    <input style="margin-right: 5px" type="radio" id="question" name="is_testimonial"
                        value="question" required>
                    <span for="question">Question</span>
                </span>
                <span>
                    <input style="margin-right: 5px" type="radio" id="testimonial" name="is_testimonial"
                        value="testimonial" required>
            ...
            <div class="mt-4 mb-5">
                ...
                <input id="image" name="image" class="art-input" type="file"
                    placeholder="Upload Image (not required)" style="cursor: pointer;"
